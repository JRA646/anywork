  ...
  return (
    <main className={'authShell authPageAnimated ' + (registering ? 'isRegistering' : 'isSigningIn') + (admin ? ' isAdminAuth' : '')}>
      <section className="authPromo">
        <button className="authPromoBrand authPromoBrandLogo authPromoMarkButton" type="button" onClick={() => window.history.back()} aria-label="Back">
          <img className="authPromoMark" src="/anywork-mark.svg" alt="ANYwork" />
        </button>
