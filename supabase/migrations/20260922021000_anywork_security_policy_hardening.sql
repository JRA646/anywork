...
revoke execute on function public.anywork_accept_quote(uuid,uuid) from anon;
revoke execute on function public.anywork_confirm_schedule(uuid,timestamptz,timestamptz,text) from anon;
revoke execute on function public.anywork_assign_provider(uuid,uuid) from anon;
revoke execute on function public.anywork_generate_provider_matches(uuid) from anon;
revoke execute on function public.anywork_match_request_providers(uuid) from anon;
revoke execute on function public.anywork_create_invoice(uuid,jsonb,numeric,numeric,timestamptz) from anon;
revoke execute on function public.anywork_open_dispute(uuid,text,text) from anon;
revoke execute on function public.anywork_notify_message() from anon,authenticated;
revoke execute on function public.anywork_notify_quote_change() from anon,authenticated;
revoke execute on function public.anywork_notify_request_change() from anon,authenticated;
revoke execute on function public.anywork_queue_quote_email() from anon,authenticated;
revoke execute on function public.anywork_record_quote_event() from anon,authenticated;
revoke execute on function public.anywork_record_request_event() from anon,authenticated;
